...
import mobile.proj.spoilers.model.Video;
import mobile.proj.spoilers.model.VideoResults;
import mobile.proj.spoilers.provider.MovieContract;
import mobile.proj.spoilers.service.ServiceGenerator;
import mobile.proj.spoilers.service.TvService;
import mobile.proj.spoilers.util.AppUtils;
import mobile.proj.spoilers.util.Constants;
import mobile.proj.spoilers.util.ContentValuesUtils;
...
public class TvDetailsActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rating_rating_bar)
    ...
    @BindView(R.id.btnSpoil) Button btnSpoil ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnSpoil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(TvDetailsActivity.this, SpoilActivity.class);
                intent.putExtra("imdbId", mId);
    ...
    private void loadFromDb() {
        if (mCursor.moveToNext()) {
            ...
            String imdbId = mCursor.getString(mCursor.getColumnIndex(MovieContract.TVs._ID));
